...
cour=4;var $ul=document.querySelector('#anime-list');var fragment=document.createDocumentFragment();$.getJSON('https://api.moemoe.tokyo/anime/v1/master/'+year+'/'+4).done(function(data){for(var i=0;i<data.length;i++){var $li=document.createElement('li');$li.innerHTML=data[i].title;fragment.appendChild($li);}
